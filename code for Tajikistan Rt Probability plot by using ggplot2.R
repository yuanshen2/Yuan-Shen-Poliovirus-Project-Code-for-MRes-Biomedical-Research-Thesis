...
ggplot(df, aes(x = dates, y = values)) +
  ...
  ylab("Prob Rt <1") +
  ylim(0, 1) +
  geom_vline(xintercept = as.numeric(as.Date("2021-07-01")), color = rgb(186/255, 85/255, 211/255), linetype = "solid") +
  geom_vline(xintercept = as.numeric(as.Date("2021-07-30")), color = rgb(186/255, 85/255, 211/255), linetype = "solid")+
  geom_vline(xintercept = as.numeric(as.Date("2021-09-30")), color = rgb(186/255, 85/255, 211/255), linetype = "solid")+
  geom_vline(xintercept = as.numeric(as.Date("2021-06-28")), color = "orange3", linetype = "solid")+
  geom_vline(xintercept = as.numeric(as.Date("2021-07-26")), color = "orange3", linetype = "solid")+
  geom_vline(xintercept = as.numeric(as.Date("2021-09-27")), color = "orange3", linetype = "solid")
