...
plot(dates,rowSums(Rsmooth[[4]][,1:20]),type="l",ylab="Prob Rt <1",ylim=c(0,1))

lines(dates,rep(sum(pR0[1:20]),length(dates)),col="blue")
Sys.setlocale("LC_TIME","English")

#Rmooth[[4]] is the posterior density. 1:20 are the values of Rgrid less than 1

#plot times of campaign dates+28 days as vertical lines on top of same graph

#best to do equivalent in ggplot
