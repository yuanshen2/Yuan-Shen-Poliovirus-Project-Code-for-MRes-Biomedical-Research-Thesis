...
#EpiEstim Plot
# add on 0s for last 3 months if last case was more than 6 months ago
Tajikistan_EpiEstim_Data<-read.csv("Tajikistan EpiEstim Data.csv")
...
figure<-ggarrange(p,paklabs,pl2,pl3,pl4,pl5,
                  labels=c("Tajikistan Incidence Plot",
                           "Tajikistan Campaign Plot",
                           "Tajikistan Poliomyelitis Reproduction Number Estimation Plot Made with EpiFliter(shape=10,scale=1)",
                           "Tajikistan Poliomyelitis Reproduction Number Estimation Plot Made with EpiEstim(mean=10,SD=sqrt(10))",
                           "Tajikistan Poliomyelitis Reproduction Number Estimation Plot Made with EpiFliter(shape=28,scale=1.5)",
                           "Tajikistan Poliomyelitis Reproduction Number Estimation Plot Made with EpiEstim(mean=42,SD=3*sqrt(7))"
                  ),
