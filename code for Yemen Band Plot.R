...
ggplot(df, aes(x = dates, y = values)) +
  ...
  ylab("Prob Rt <1") +
  ylim(0, 1) +
  geom_rect(xmin = as.Date("2022-02-01"), xmax = as.Date("2022-02-01"), 
            ymin = -Inf, ymax = Inf, fill = "slateblue", alpha = 0.01) +
  geom_rect(xmin = as.Date("2022-02-19"), xmax = as.Date("2022-02-21"), 
            ymin = -Inf, ymax = Inf, fill = "slateblue", alpha = 0.01) +
  geom_rect(xmin = as.Date("2022-06-26"), xmax = as.Date("2022-06-27"), 
            ymin = -Inf, ymax = Inf, fill = "slateblue", alpha = 0.01)
