...
#read data
pol_dat<-read.csv("Pakistan_GIK.csv",stringsAsFactors = F)
#format dates
...
#Incidence Plot
Pakistan_GIK_Incidence$Date_Onset<-as.Date(Pakistan_GIK_Incidence$Date_Onset)
library(ggplot2)
library(incidence)
dat<-Pakistan_GIK_Incidence$Date_Onset
i<-incidence(dat)
plot(i)
...
#Campaign Plot
campaigns<-read.csv("GIK Campaigns.csv")
...
#EpiEstim Plot
# add on 0s for last 3 months if last case was more than 6 months ago
Pakistan_EpiEstim_Data<-read.csv("Pakistan GIK EpiEstim Data.csv")
...
figure<-ggarrange(p,paklabs,pl2,pl3,pl4,pl5,
                  labels=c("GIK Incidence Plot",
                           "GIK Campaign Plot",
                           "GIK Poliomyelitis Reproduction Number Estimation Plot Made with EpiFliter(shape=10,scale=1)",
                           "GIK Poliomyelitis Reproduction Number Estimation Plot Made with EpiEstim(mean=10,SD=sqrt(10))",
                           "GIK Poliomyelitis Reproduction Number Estimation Plot Made with EpiFliter(shape=28,scale=1.5)",
                           "GIK Poliomyelitis Reproduction Number Estimation Plot Made with EpiEstim(mean=42,SD=3*sqrt(7))"
                  ),
