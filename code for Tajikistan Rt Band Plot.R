...
ggplot(df, aes(x = dates, y = values)) +
  ...
  ylab("Prob Rt <1") +
  ylim(0, 1) +
  geom_rect(xmin = as.Date("2021-06-28"), xmax = as.Date("2021-07-01"), 
            ymin = -Inf, ymax = Inf, fill = "slateblue", alpha = 0.01) +
  geom_rect(xmin = as.Date("2021-07-26"), xmax = as.Date("2021-07-30"), 
            ymin = -Inf, ymax = Inf, fill = "slateblue", alpha = 0.01) +
  geom_rect(xmin = as.Date("2021-09-27"), xmax = as.Date("2021-09-30"), 
            ymin = -Inf, ymax = Inf, fill = "slateblue", alpha = 0.01)
